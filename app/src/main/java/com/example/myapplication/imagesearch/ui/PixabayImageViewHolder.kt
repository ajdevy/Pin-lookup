...
class PixabayImageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private val ivImage: ImageView = itemView.findViewById(R.id.displayImageView)
    private val tvImageId: TextView = itemView.findViewById(R.id.displayImageIdTextView)
    private val tvUserName: TextView = itemView.findViewById(R.id.displayUserNameTextView)
    private val tvTags: TextView = itemView.findViewById(R.id.displayTagsTextView)
